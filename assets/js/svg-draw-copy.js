...
const f_svg_draw_copy = function(box) {
	svg_draw_copy.count++;
	const svg_draw_info = svg_draw_copy;
...
window.addEventListener("load", function() {
	for (let svg_draw_box of document.querySelectorAll(`svg[draw="copy"]`)) {
		f_svg_draw_copy(svg_draw_box);
	}
});
